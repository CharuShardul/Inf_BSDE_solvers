...
err_ub = []
for i in dims:
    err_u.append(np.load('Numerical_experiments/error_plots/u_err_{}d.npy'.format(i)))
    err_ub.append(np.sqrt(i)*np.load('Numerical_experiments/error_plots/ub_err_{}d.npy'.format(i)))
